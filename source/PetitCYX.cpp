...
namespace CTRPluginFramework {
    void CYX::Initialize(void) {
        switch (g_region) {
            case JPN:
                currentVersion = *(u32*)JPN_VERSION_INT; break;
            case USA:
                currentVersion = *(u32*)USA_VERSION_INT; break;
            case EUR:
                currentVersion = *(u32*)EUR_VERSION_INT; break;
        }
    }
    ...
    void CYX::ReplaceServerName(std::string& saveURL, std::string& loadURL){
        u32 addresses[] = {
            ...
            EUR_SERVERNAME_LOAD2_1, EUR_SERVERNAME_LOAD2_2,
            EUR_SERVERNAME_SAVE3_1, EUR_SERVERNAME_SAVE3_2,
            EUR_SERVERNAME_SHOW2,
            EUR_SERVERNAME_LIST2,
            EUR_SERVERNAME_INFO2,
            EUR_SERVERNAME_DELETE2,
            EUR_SERVERNAME_SHOPLIST2,
            EUR_SERVERNAME_PREPURCHASE2,
            EUR_SERVERNAME_PURCHASE2
        };
